...
let escolhaUsuario = prompt('Escolha uma imagem para substituir: 1- Tigre, 2- Leão, 3- Leopardo, 4- Pantera negra,  5- Jaguar  e 6- Guepardo : ')


let urlImagem = prompt('Insira a URL da nova imagem: ')
